  ...
  <div className='ContainerGalerieEnfant'>
     <Header_EL className="header_EL"/> 
      <div className='blocgalerie_EL'>    
        <div className='titreGalerie  align-items-center'> <h1 className=''>GALERIE </h1><svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-camera-fill " viewBox="0 0 16 16">
